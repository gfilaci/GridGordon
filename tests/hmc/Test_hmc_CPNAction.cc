...
Source file: ./tests/Test_hmc_CPNAction.cc
...
int main(int argc, char **argv) {
  ...
  typedef HMCWrapperTemplate<CPNImplR<N>, MinimumNorm2, Representations<EmptyRep<typename CPNImplR<N>::Field> >> HMCWrapper;
